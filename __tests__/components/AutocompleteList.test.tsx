...
describe("AutocompleteList", () => {
  ...
  it("renders a list of items when open and items are provided", () => {
    render(<AutocompleteList items={mockItems} isOpen={true} onSelect={onSelect} onClose={onClose} />);
  ...
  it("renders nothing when items is empty", () => {
    const { container } = render(<AutocompleteList items={[]} isOpen={true} onSelect={onSelect} onClose={onClose} />);
    expect(container.firstChild).toBeNull();
  });
